...
# Route to get all books, or filter by title/author if query params are provided
@app.route('/api/books', methods=['GET'])
def get_books():
    """
    Get the list of all books, or filter books by title or author if query parameters are provided.
    """
    # Get query parameters (title and author are optional)
